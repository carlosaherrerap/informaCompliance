    ...
    <div className="h-screen flex flex-col bg-[#F4F7FA] overflow-hidden font-sans text-[#111318]">
      <div className="flex h-screen overflow-hidden relative">
        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
          ...
          <footer className="py-3 bg-white border-t border-slate-200 flex items-center justify-center shrink-0">
            <p className="text-[9px] font-bold text-slate-300 tracking-widest">@Copyright; Desarrollado por el área de TI-InformaPerú. Todos los derechos reservados 2026</p>
          </footer>
        </main>
      </div>
    </div>
